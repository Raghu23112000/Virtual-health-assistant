...
<!-- result -->
	...
	<button style="float: center;margin-left: 0px;background-color:white;color: antiquewhite;width: 115px;height: 30px;margin-bottom: 20px;margin-top:20px;">
